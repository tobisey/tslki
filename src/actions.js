export function defaults() {
    return {
        ...
        dragCoords: null,
        worksVisible: [
            {name: 'works', x: 400, y: 40, x2: 400, y2: 40},
            {name: 'epWorks', x: 360, y: 46, x2: 360, y2: 46},
            ...
            {id: 4, name: 'notStatic', visible: false, x: 30, y:90, x2: 30, y2: 90},
